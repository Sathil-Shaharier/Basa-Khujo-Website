...
<body>
    <div class="container" style="margin:100px; margin-bottom: 100px;">
        <h1 class="text-center text-warning fs-1">Wanna Post for recomend your needs for your house.</h1>
        <form class="form-control" style="margin-top: 50px;"   action="http://localhost/Basha-khujo/backend_file/user_post_connection.php" method="post">
            <div>
            ...
            <div>
                <label for="formFileLg" class="form-label fs-3">Put your Expected Basha Cost</label>
                <input class="form-control form-control-lg" id="formFileLg" type="text" name="cost">
            </div>
            <div>
                <label for="formFileLg" class="form-label fs-3">How many rooms you need?</label>
                <input class="form-control form-control-lg" id="formFileLg" type="text" name="roomNumber">
            </div>
            <div>
                <label for="formFileLg" class="form-label fs-3">How many baths you need?</label>
                <input class="form-control form-control-lg" id="formFileLg" type="text" name="baths">
            </div>
            <div>
                <label for="formFileLg" class="form-label fs-3">How many square feet it will be?</label>
            ...
            <div>
                <label for="formFileLg" class="form-label fs-3">About something you wanna tell about it:</label>
