...
<body>
    <div class="contain">
        <div class="forms-container">
            <div class="signin">
                <form action="http://localhost/basha-khujo/backend_file/user_login_connection.php" method="post" class="sign-in-form">
                    <h1 class="top-title">Wanna find your Renter easily.</h1>
        ...
        <div class="panels-container">
            <div class="panel left-panel">
                <div class="content">
                    <h3>New here ?</h3>
                    <p>
                        Registration The best house searching site to get best experiance.
                    </p>
                    <a class="btn-link" href="http://localhost/basha-khujo/owner/owner_signup.php"><button class="btn1 transparent" id="sign-up-btn">
                            Sign up
                        </button></a>
